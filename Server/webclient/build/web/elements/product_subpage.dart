...
class ProductSubpage extends PolymerElement with ChangeNotifier  {
  List products = toObservable([]);
  
  @reflectable @observable int get productType => __$productType; int __$productType = 0; @reflectable set productType(int value) { __$productType = notifyPropertyChange(#productType, __$productType, value); }
  @reflectable @observable String get productImageUrl => __$productImageUrl; String __$productImageUrl; @reflectable set productImageUrl(String value) { __$productImageUrl = notifyPropertyChange(#productImageUrl, __$productImageUrl, value); }
  @reflectable @observable String get productNameCn => __$productNameCn; String __$productNameCn; @reflectable set productNameCn(String value) { __$productNameCn = notifyPropertyChange(#productNameCn, __$productNameCn, value); }
  @reflectable @observable String get productNameEn => __$productNameEn; String __$productNameEn; @reflectable set productNameEn(String value) { __$productNameEn = notifyPropertyChange(#productNameEn, __$productNameEn, value); }
  @reflectable @observable String get productId => __$productId; String __$productId; @reflectable set productId(String value) { __$productId = notifyPropertyChange(#productId, __$productId, value); }
  @reflectable @observable String get productUnitName => __$productUnitName; String __$productUnitName; @reflectable set productUnitName(String value) { __$productUnitName = notifyPropertyChange(#productUnitName, __$productUnitName, value); }
  @reflectable @observable int get productIsDescimal => __$productIsDescimal; int __$productIsDescimal = 0; @reflectable set productIsDescimal(int value) { __$productIsDescimal = notifyPropertyChange(#productIsDescimal, __$productIsDescimal, value); }
