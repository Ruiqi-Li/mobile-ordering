...
class CustomerSubpage extends PolymerElement {
  ...
  @observable bool receiveOrder;
  @observable bool changeStorage;
  @observable bool editTemplate;
  
  @observable String customerNameCn;
  @observable String customerNameEn;
  @observable String customerHuphendId;
  @observable String directorDispalyName;
  @observable String directorLoginName;
  @observable String directorPassword;
  
  @observable int panelSelected;
